...
namespace TicTacToe {
	...
	public ref class PVPGame : public System::Windows::Forms::Form
	{
	...
	private: System::Windows::Forms::PictureBox^ p2Diamond2;

	private: System::Windows::Forms::PictureBox^ p2Diamond1;

	private: System::Windows::Forms::PictureBox^ p1Diamond2;

	private: System::Windows::Forms::PictureBox^ p1Diamond1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PVPGame::typeid));
			...
			this->p2Diamond2 = (gcnew System::Windows::Forms::PictureBox());
			this->p2Diamond1 = (gcnew System::Windows::Forms::PictureBox());
			this->p1Diamond2 = (gcnew System::Windows::Forms::PictureBox());
			this->p1Diamond1 = (gcnew System::Windows::Forms::PictureBox());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p2Diamond2))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p2Diamond1))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p1Diamond2))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p1Diamond1))->BeginInit();
			...
			this->opponentTurn->Tick += gcnew System::EventHandler(this, &PVPGame::opponentTurn_Tick);
			// 
			// panel1
			// 
			...
			this->panel1->Controls->Add(this->p2Diamond2);
			this->panel1->Controls->Add(this->p2Diamond1);
			this->panel1->Controls->Add(this->p1Diamond2);
			this->panel1->Controls->Add(this->p1Diamond1);
			...
			this->gameAgainBtn->Click += gcnew System::EventHandler(this, &PVPGame::gameAgainBtn_Click);
			// 
			// turnText
			// 
			...
			// p2Diamond2
			// 
			this->p2Diamond2->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"p2Diamond2.BackgroundImage")));
			this->p2Diamond2->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Zoom;
			this->p2Diamond2->Location = System::Drawing::Point(168, 172);
			this->p2Diamond2->Name = L"p2Diamond2";
			this->p2Diamond2->Size = System::Drawing::Size(32, 30);
			this->p2Diamond2->TabIndex = 13;
			this->p2Diamond2->TabStop = false;
			this->p2Diamond2->Visible = false;
			// 
			// p2Diamond1
			// 
			this->p2Diamond1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"p2Diamond1.BackgroundImage")));
			this->p2Diamond1->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Zoom;
			this->p2Diamond1->Location = System::Drawing::Point(130, 172);
			this->p2Diamond1->Name = L"p2Diamond1";
			this->p2Diamond1->Size = System::Drawing::Size(32, 30);
			this->p2Diamond1->TabIndex = 12;
			this->p2Diamond1->TabStop = false;
			this->p2Diamond1->Visible = false;
			// 
			// p1Diamond2
			// 
			this->p1Diamond2->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"p1Diamond2.BackgroundImage")));
			this->p1Diamond2->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Zoom;
			this->p1Diamond2->ErrorImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"p1Diamond2.ErrorImage")));
			this->p1Diamond2->Location = System::Drawing::Point(168, 136);
			this->p1Diamond2->Name = L"p1Diamond2";
			this->p1Diamond2->Size = System::Drawing::Size(32, 30);
			this->p1Diamond2->TabIndex = 11;
			this->p1Diamond2->TabStop = false;
			this->p1Diamond2->Visible = false;
			// 
			// p1Diamond1
			// 
			this->p1Diamond1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"p1Diamond1.BackgroundImage")));
			this->p1Diamond1->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Zoom;
			this->p1Diamond1->Location = System::Drawing::Point(130, 136);
			this->p1Diamond1->Name = L"p1Diamond1";
			this->p1Diamond1->Size = System::Drawing::Size(32, 30);
			this->p1Diamond1->TabIndex = 10;
			this->p1Diamond1->TabStop = false;
			this->p1Diamond1->Visible = false;
			// 
			// quitBtn
			// 
			...
			this->quitBtn->Click += gcnew System::EventHandler(this, &PVPGame::quitBtn_Click);
			// 
			// draw
			// 
			...
			this->player1Txt->Text = L"Player1:";
			...
			this->eightBtn->Click += gcnew System::EventHandler(this, &PVPGame::eightBtn_Click);
			// 
			// sevenBtn
			// 
			...
			this->sevenBtn->Click += gcnew System::EventHandler(this, &PVPGame::sevenBtn_Click);
			// 
			// sixBtn
			// 
			...
			this->sixBtn->Click += gcnew System::EventHandler(this, &PVPGame::sixBtn_Click);
			// 
			// fiveBtn
			// 
			...
			this->fiveBtn->Click += gcnew System::EventHandler(this, &PVPGame::fiveBtn_Click);
			// 
			// fourBtn
			// 
			...
			this->fourBtn->Click += gcnew System::EventHandler(this, &PVPGame::fourBtn_Click);
			// 
			// threeBtn
			// 
			...
			this->threeBtn->Click += gcnew System::EventHandler(this, &PVPGame::threeBtn_Click);
			// 
			// twoBtn
			// 
			...
			this->twoBtn->Click += gcnew System::EventHandler(this, &PVPGame::twoBtn_Click);
			// 
			// oneBtn
			// 
			...
			this->oneBtn->Click += gcnew System::EventHandler(this, &PVPGame::oneBtn_Click);
			// 
			// zeroBtn
			// 
			...
			this->zeroBtn->Click += gcnew System::EventHandler(this, &PVPGame::zeroBtn_Click);
			// 
			// gamePanel
			// 
			...
			this->label2->Text = L"Player vs. Player";
			// 
			// PVPGame
			// 
			...
			this->Text = L"Player vs. Player";
			this->panel1->ResumeLayout(false);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p2Diamond2))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p2Diamond1))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p1Diamond2))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->p1Diamond1))->EndInit();
...
#pragma endregion
	...
	private: void checkThreeDiamondWinner() {
		...
		{
			ResultAnnouncePVP^ resultAnnouncePVP = gcnew ResultAnnouncePVP();
			resultAnnouncePVP->Show();
			this->Close();
		}
	}
	...
	private: void updateScores() {
		...
		{
			p1Diamond1->Visible = true;
		}
		else if (gStats.getPlayerScore() == 2) {
			p1Diamond2->Visible = true;
		}

		if (gStats.getAIScore() == 1) {
			p2Diamond1->Visible = true;
		}
		else if (gStats.getAIScore() == 2) {
			p2Diamond2->Visible = true;
		}
	}
